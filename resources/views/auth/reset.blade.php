                        ...
                        <div class="fxt-header">
                            <div class="fxt-transformY-50 fxt-transition-delay-1">
                                <a href="/" class="fxt-logo"><img
                                    src="{{ asset('images/minlogo.png') }}" alt="Logo"></a>
                            </div>
                            <div class="fxt-transformY-50 fxt-transition-delay-2">
                                <h1>Selamat datang di Bantuin</h1>
                            </div>
                            <div class="fxt-transformY-50 fxt-transition-delay-3">
                                <p>Tempat terbaik buat kamu yang ingin mencari uang dengan membantu orang lain, dan tempat terbaik
                ...
                <div class="col-md-6 col-12 fxt-bg-color">
                    <div class="fxt-content">
                            ...
                            <form method="post" action="/change" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('password') is-invalid @enderror" type="password"
                                        name="password" id="password" required placeholder="Masukkan Password Baru">
                                    <input type="text" class="d-none" id="token" name="token" value="{{ $token }}">
                                    <input type="text" class="d-none" id="token_type" name="token_type" value="{{ $token_type }}">
                                    <input type="text" class="d-none" id="user_id" name="user_id" value="{{ $user_id }}">
                        ...
                        <div class="text-center">
                            <p>Already have an password?<a href="/" class="switcher-text2 inline-text">Log in</a></p>
                        </div>
                    </div>
                </div>
            </div>
